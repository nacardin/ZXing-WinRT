...
namespace ZXing.Common.ReedSolomon
{
   ...
   public sealed class GenericGF
   {
      ...
      internal static GenericGF AZTEC_DATA_6 = new GenericGF(0x43, 64, 1); // x^6 + x + 1
      internal static GenericGF AZTEC_PARAM = new GenericGF(0x13, 16, 1); // x^4 + x + 1
      internal static GenericGF QR_CODE_FIELD_256 = new GenericGF(0x011D, 256, 0); // x^8 + x^4 + x^3 + x^2 + 1
      internal static GenericGF DATA_MATRIX_FIELD_256 = new GenericGF(0x012D, 256, 1); // x^8 + x^5 + x^3 + x^2 + 1
      internal static GenericGF AZTEC_DATA_8 = DATA_MATRIX_FIELD_256;
      internal static GenericGF MAXICODE_FIELD_64 = AZTEC_DATA_6;
