...
namespace ZXing.Rendering
{
   ...
   public interface IBarcodeRenderer
   {
      ...
      /// <returns></returns>
      PixelData Render(BitMatrix matrix, BarcodeFormat format, string content);
      ...
      /// <returns></returns>
      PixelData Render(BitMatrix matrix, BarcodeFormat format, string content, EncodingOptions options);
   }
}
