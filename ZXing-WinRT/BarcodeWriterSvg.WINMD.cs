...
namespace ZXing
{
   ...
   /// The result is a Svg Image object
   /// </summary>
   public sealed class BarcodeWriterSvg : IBarcodeWriterSvg
   {
      ...
      /// </summary>
      public IBarcodeRendererSvg Renderer { get; set; }
      ...
      /// <param name="contents">The contents.</param>
      /// <returns></returns>
      public SvgImage Write(string contents)
      {
         if (Renderer == null)
         {
      ...
      /// <returns></returns>
      internal SvgImage Write(BitMatrix matrix)
      {
         if (Renderer == null)
         {
            throw new InvalidOperationException("You have to set a renderer instance.");
